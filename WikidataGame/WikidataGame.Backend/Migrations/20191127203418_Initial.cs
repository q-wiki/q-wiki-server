    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("5f7e813a-3cfa-4617-86d1-514b481b37a8"), new Guid("6c22af9b-2f45-413b-995d-7ee6c61674e5"), 2, @"# What's the chemical symbol for {element}?
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("a4a7289a-3053-4ad7-9c60-c75a18305243"), new Guid("1b9185c0-c46b-4abf-bf82-e464f5116c7d"), 0, @"# sort planets by average distance to sun
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("0d218830-55d2-4d66-8d8f-d402514e9202"), new Guid("f9c52d1a-9315-423d-a818-94c1769fffe5"), 2, @"# wars of the 20th century
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("d135088c-e062-4016-8eb4-1d68c72915ea"), new Guid("f9c52d1a-9315-423d-a818-94c1769fffe5"), 2, @"# empires and colonies
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("86b64102-8074-4c4e-8f3e-71a0e52bb261"), new Guid("f9c52d1a-9315-423d-a818-94c1769fffe5"), 2, @"# German Chancellors
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("909182d1-4ae6-46ea-bd9b-8c4323ea53fa"), new Guid("f9c52d1a-9315-423d-a818-94c1769fffe5"), 0, @"# sort EU countries by the date they joined
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("d9011896-04e5-4d32-8d3a-02a6d2b0bdb6"), new Guid("f9c52d1a-9315-423d-a818-94c1769fffe5"), 0, @"
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("bc7a22ee-4985-44c3-9388-5c7dd6b8762e"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 0, @"# sort countries by number of inhabitants (ascending)
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("29fed1d0-d306-4946-8109-63b8aaf0262e"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"# What is the longest river in {continent}?
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("2ed01768-9ab6-4895-8cbf-09dbc6f957e0"), new Guid("1b9185c0-c46b-4abf-bf82-e464f5116c7d"), 0, @"# sort planets by radius
                        SELECT ?answer ?question WHERE {
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("a6a470de-9efb-4fde-9388-6eb20f2ff1f4"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"# Which country is no basin country of the Mediterranean Sea?
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("46679c4f-ef97-445d-9a70-d95a5337720f"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"SELECT DISTINCT ?question ?answer
                        WITH {
                          SELECT DISTINCT (?state as ?country) WHERE {
                            ?state wdt:P31/wdt:P279* wd:Q3624078;
                                   p:P463 ?memberOfStatement.
                        ...
                        order by DESC(?question)", "Which country is not a basin country of the Baltic Sea?" });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("9a70639b-3447-475a-905a-e866a0c98a1c"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"SELECT ?answer ?question
                        WITH {
                        ...
                        ORDER BY DESC(?question)", "Which country is a part of {0}?" });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("aca0f5f7-b000-42fb-b713-f5fe43748761"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"SELECT ?continent ?answer ?question WHERE {
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("a4b7c4ba-6acb-4f9a-821b-7a44aa7b6761"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"SELECT DISTINCT ?answer ?question WHERE {
                      ?state wdt:P31/wdt:P279* wd:Q3624078;
                             p:P463 ?memberOfStatement.
                      ?memberOfStatement a wikibase:BestRank;
                                           ps:P463 wd:Q1065.
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("bba18c92-47a6-4541-9305-d6453ad8477a"), new Guid("6c22af9b-2f45-413b-995d-7ee6c61674e5"), 0, @"
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("8273acfe-c278-4cd4-92f5-07dd73a22577"), new Guid("6c22af9b-2f45-413b-995d-7ee6c61674e5"), 2, @"# Which chemical compound has the formula {0}?
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("e8f99165-baa3-47b2-be35-c42ab2d5f0a0"), new Guid("6c22af9b-2f45-413b-995d-7ee6c61674e5"), 0, @"#sort chemical elements by number in period system
                        SELECT ?question ?answer WHERE {
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("40677b0f-9d5f-46d2-ab85-a6c40afb5f87"), new Guid("6c22af9b-2f45-413b-995d-7ee6c61674e5"), 2, @"SELECT ?question ?answer WHERE {
                      ?element wdt:P31 wd:Q11344;
                               wdt:P1086 ?number;
                               wdt:P246 ?question.
                      FILTER(1 <= ?number &&
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("4f6c477e-7025-44b4-a3b0-f3ebd8902902"), new Guid("cf3111af-8b18-4c6f-8ee6-115157d54b79"), 2, @"# Which country is no basin country of the Caribbean Sea?
                        SELECT DISTINCT ?question ?answer
                        WITH {
                          SELECT DISTINCT (?state as ?country) WHERE {
                            ?state wdt:P31/wdt:P279* wd:Q3624078;
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "CategoryId", "MiniGameType", "SparqlQuery", "TaskDescription" },
                values: new object[] { new Guid("14d93797-c61c-4415-b1ed-359d180237ff"), new Guid("1b9185c0-c46b-4abf-bf82-e464f5116c7d"), 2, @"#Which of these moons belongs to the planet {0}?
