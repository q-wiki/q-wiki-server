...
namespace WikidataGame.ApiClient.Sample
{
    class Program
    {
        ...
        {
            //Authentication
            var apiClient = new WikidataGameAPI(new Uri("http://localhost:54264"), new TokenCredentials("auth"));
            ...
            var apiClient2 = new WikidataGameAPI(new Uri("http://localhost:54264"), new TokenCredentials(auth.Bearer));
            ...
            Console.WriteLine($"My player id is {fullGame.Me.DeviceId}.");
            Console.ReadLine();
        }
    }
}