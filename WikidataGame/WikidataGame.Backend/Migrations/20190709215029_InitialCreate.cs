    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a4b7c4ba-6acb-4f9a-821b-7a44aa7b6761", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"SELECT DISTINCT ?answer ?question WHERE {
                    ...
                    { "aca0f5f7-b000-42fb-b713-f5fe43748761", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"SELECT ?continent ?answer ?question WHERE {
                    ...
                    { "9a70639b-3447-475a-905a-e866a0c98a1c", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"SELECT ?answer ?question
                                        WITH {
                    ...
                    { "46679c4f-ef97-445d-9a70-d95a5337720f", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"SELECT DISTINCT ?question ?answer
                                        WITH {
                    ...
                    { "4f6c477e-7025-44b4-a3b0-f3ebd8902902", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"# Which country is no basin country of the Caribbean Sea?
                    ...
                    { "a6a470de-9efb-4fde-9388-6eb20f2ff1f4", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"# Which country is no basin country of the Mediterranean Sea?
                                        SELECT DISTINCT ?question ?answer
                                        WITH {
                                          SELECT DISTINCT (?state as ?country) WHERE {
                                            ?state wdt:P31/wdt:P279* wd:Q3624078;
                    ...
                    { "29fed1d0-d306-4946-8109-63b8aaf0262e", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 2, @"# What is the longest river in {continent}?
                    ...
                    { "bc7a22ee-4985-44c3-9388-5c7dd6b8762e", "cf3111af-8b18-4c6f-8ee6-115157d54b79", 0, @"# sort countries by number of inhabitants (ascending)
                    ...
                    { "a4a7289a-3053-4ad7-9c60-c75a18305243", "1b9185c0-c46b-4abf-bf82-e464f5116c7d", 0, @"# sort planets by average distance to sun
                    ...
                    { "2ed01768-9ab6-4895-8cbf-09dbc6f957e0", "1b9185c0-c46b-4abf-bf82-e464f5116c7d", 0, @"# sort planets by radius
                                        SELECT ?answer ?question WHERE {
                    ...
                    { "14d93797-c61c-4415-b1ed-359d180237ff", "1b9185c0-c46b-4abf-bf82-e464f5116c7d", 2, @"#Which of these moons belongs to the planet {0}?
                    ...
                    { "5f7e813a-3cfa-4617-86d1-514b481b37a8", "6c22af9b-2f45-413b-995d-7ee6c61674e5", 2, @"# What's the chemical symbol for {element}?
                    ...
                    { "40677b0f-9d5f-46d2-ab85-a6c40afb5f87", "6c22af9b-2f45-413b-995d-7ee6c61674e5", 2, @"SELECT ?question ?answer WHERE {
                                      ?element wdt:P31 wd:Q11344;
                                               wdt:P1086 ?number;
                                               wdt:P246 ?question.
                                      FILTER(1 <= ?number &&
                    ...
                    { "e8f99165-baa3-47b2-be35-c42ab2d5f0a0", "6c22af9b-2f45-413b-995d-7ee6c61674e5", 0, @"#sort chemical elements by number in period system
                                        SELECT ?question ?answer WHERE {
